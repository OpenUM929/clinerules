...
**문서 위치**: `.clinerules/projects/msys/mapper/README.md`
...
| [grp-memo-mapper.md](grp-memo-mapper.md) | grp_memo_mapper.py |
| [icon-mapper.md](icon-mapper.md) | icon_mapper.py |
| [jandi-mapper.md](jandi-mapper.md) | jandi_mapper.py |
| [mngr-sett-mapper.md](mngr-sett-mapper.md) | mngr_sett_mapper.py |
