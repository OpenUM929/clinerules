...
<tr>
  <td class="doctitle" colspan="2">MSYS 운영자 메뉴얼 (통합본)</td>
  <td><span class="label">문서번호</span><span class="val">MSYS-OPS-00~08</span></td>
</tr>
<tr>
...
<tr>
  <td colspan="2"><span class="label">적용 범위</span><span class="val">빠른 시작부터 백업·복구까지 운영 전 과정 (통합)</span></td>
  <td><span class="label">승인</span><span class="val">운영팀장</span></td>
</tr>
</table>

<div class="chapter">제1장 빠른 시작<span class="docno">MSYS-OPS-00</span></div>
...
<div class="chapter">제2장 시스템 개요<span class="docno">MSYS-OPS-01</span></div>
...
<div class="chapter">제3장 환경 설정<span class="docno">MSYS-OPS-02</span></div>
...
<div class="chapter">제4장 배포 절차<span class="docno">MSYS-OPS-03</span></div>
...
<div class="chapter">제5장 공통 메뉴<span class="docno">MSYS-OPS-04</span></div>

<h2>5.1 대시보드 <code>MSYS-OPS-04-01</code></h2>
...
<img src="04-common-menus/images/dashboard-full.png" width="800" alt="대시보드 전체 화면">
...
<img src="04-common-menus/images/dashboard-summary-panel.png" width="800" alt="요약 패널">
...
<img src="04-common-menus/images/dashboard-job-details.png" width="800" alt="Job ID별 상세 현황 테이블">
...
<img src="04-common-menus/images/dashboard-job-details-search.png" width="800" alt="실시간 검색 결과">
...
<img src="04-common-menus/images/dashboard-event-log.png" width="800" alt="이벤트 로그 (펼침)">
...
<img src="04-common-menus/images/dashboard-event-log-collapsed.png" width="800" alt="이벤트 로그 (접힘)">
...
<h2>5.2 수집 스케줄 <code>MSYS-OPS-04-02</code></h2>
...
<img src="04-common-menus/images/collection-schedule-full.png" width="800" alt="수집 스케줄 전체 화면">
...
<img src="04-common-menus/images/collection-schedule-controls.png" width="800" alt="컨트롤 영역">
...
<img src="04-common-menus/images/collection-schedule-calendar.png" width="800" alt="캘린더 그리드">

#### ④ 그룹 팝업 (`.popup`)

<img src="04-common-menus/images/collection-schedule-group-popup.png" width="600" alt="그룹 팝업">
...
<img src="04-common-menus/images/collection-schedule-memo-popup.png" width="800" alt="그룹 메모 팝업">
...
<img src="04-common-menus/images/collection-schedule-settings-expanded.png" width="800" alt="설정 패널 (펼침)">
...
<h2>5.3 차트 분석 <code>MSYS-OPS-04-03</code></h2>
...
<img src="04-common-menus/images/chart-analysis-full.png" width="800" alt="차트 분석 전체 화면">
...
<img src="04-common-menus/images/chart-analysis-filter-panel.png" width="800" alt="Job ID 선택 및 필터 패널">
...
<h2>5.4 데이터 분석 <code>MSYS-OPS-04-04</code></h2>
...
<img src="04-common-menus/images/data-analysis-full.png" width="800" alt="데이터 분석 전체 화면">
...
<h2>5.5 데이터 명세 <code>MSYS-OPS-04-05</code></h2>
...
<img src="04-common-menus/images/data-spec-full.png" width="800" alt="데이터 명세서 전체 화면">
...
<img src="04-common-menus/images/data-spec-add-modal.png" width="600" alt="명세서 등록 모달">
...
<h2>5.6 카드 요약 <code>MSYS-OPS-04-06</code></h2>
...
<img src="04-common-menus/images/card-summary-full.png" width="800" alt="카드 요약 전체 화면">
...
<h2>5.7 매핑 <code>MSYS-OPS-04-07</code></h2>
...
<h2>5.8 API 키 관리 <code>MSYS-OPS-04-08</code></h2>
...
<h2>5.9 잔디 연동 <code>MSYS-OPS-04-09</code></h2>
...
<img src="04-common-menus/images/jandi-full.png" width="800" alt="잔디 모니터링 전체 화면">
...
<h2>5.10 원본 데이터 <code>MSYS-OPS-04-10</code></h2>
...
<h2>5.11 사용자 관리 <code>MSYS-OPS-04-11</code></h2>
...
<h2>5.12 API 테스트 <code>MSYS-OPS-04-12</code></h2>
...
<h2>5.13 외부 링크 <code>MSYS-OPS-04-13</code></h2>
...
<div class="chapter">제6장 관리자 설정<span class="docno">MSYS-OPS-05</span></div>
...
<div class="chapter">제7장 일상 운영<span class="docno">MSYS-OPS-06</span></div>
...
<div class="chapter">제8장 장애 대응<span class="docno">MSYS-OPS-07</span></div>
...
<div class="chapter">제9장 백업·복구<span class="docno">MSYS-OPS-08</span></div>
...
<div class="doc-footer">
  <span><b>MSYS-OPS-00~08</b> · Rev. 1.0</span>
  <span>1 / 1</span>
</div>
