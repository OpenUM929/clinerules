...
**문서 위치**: `.clinerules/projects/msys/routes/README.md`
...
### API Routes (url_prefix `/api/...`)
| 파일 | Blueprint | 설명 |
|------|-----------|------|
| `api/auth_api.py` | `auth_api` (`/api/auth`) | 인증 API |
| `api/dashboard_api.py` | `dashboard_api` (`/api/dashboard`) | 대시보드 API |
| `api/data_definition_api.py` | `data_definition_api` (`/api/data_definition`) | 데이터 정의 API |
| `api/card_summary_api.py` | `card_summary_api` (`/api/card_summary`) | 카드 요약 API |
| `api/api_key_mngr_routes.py` | `api_key_mngr_api` (`/api`) | API 키 관리 API |
| `api/analysis_api.py` | `analysis_api` (`/api/analytics`) | 분석 API |
| `api/popup_routes.py` | `popup_api` (`/api/popups`) | 팝업 API |
...
| [api-api-key-mngr.md](api-api-key-mngr.md) | api/api_key_mngr_routes.py |
