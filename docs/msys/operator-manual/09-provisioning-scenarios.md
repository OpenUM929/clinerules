...
- **단계별 화면**:
  1. 데이터 정의 관리에서 **그룹 코드 생성**(100단위).
     <img src="images/provision-scn2-group.png" width="600" alt="그룹 코드 생성">
  2. 그 그룹에 **상세코드(데이터 A) 추가** — 이름·설명·수집 파라미터 입력.
     <img src="images/provision-scn2-detail.png" width="600" alt="상세코드 추가">
  3. [API 키 관리](04-common-menus/08-api-key-mngr.md)에서 데이터 A 코드로 **키 등록**(만료·담당자).
     <img src="images/provision-scn2-apikey.png" width="600" alt="API 키 등록">
