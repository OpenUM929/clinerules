...
### 테스트 / 코드 리뷰 시
- `docs/verification/testing-strategy.md` - 테스트 전략
- `docs/verification/code-review-checklist.md` - 코드 리뷰 체크리스트

### 메뉴얼 / 문서 작성 시
- `docs/msys/operator-manual/DEVELOPMENT.md` - 운영자 메뉴얼 작성 규칙 및 템플릿
