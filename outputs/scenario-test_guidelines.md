...
**문서 위치**: `.clinerules/outputs/scenario-test_guidelines.md`
...
## 시나리오 G-6: UI 기본기 확인/적용 요청

### 상황
사용자: "UI 기본기(버튼/카드 색상, 폰트 등)가 뭐야? 디자인 시스템 문서 봐줘"

### 올바른 진행

| 단계 | 규칙 | 실행 내용 |
|------|------|----------|
| 1 | 00-core.md | "공통 UI/디자인" 또는 핵심 규칙 문서 위치 |
| 2 | 04.design-change.md 또는 핵심 규칙 문서 위치 | design-system/00-overview.md 참조 |
| 3 | design-system/00-overview.md | 필요한 주제의 상세 문서로 이동 |
| 4 | design-system/01-design-tokens.md | 색상/타이포그래피/간격 값 확인 |
| 5 | design-system/02~07*.md | 컴포넌트별 상세 스타일 확인 |
| 6 | mockup/design_system.html | 브라우저로 시각적 mockup 확인 |
| 7 | 적용 | 모든 페이지에 일관된 클래스와 디자인 토큰 사용 |

### 결과
✅ 디자인 시스템 문서 체계를 통해 일관된 UI 기본기 적용 가능